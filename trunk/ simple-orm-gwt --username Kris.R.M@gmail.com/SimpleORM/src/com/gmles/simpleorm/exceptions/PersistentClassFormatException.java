...
public class PersistentClassFormatException extends Exception {
	private static final long serialVersionUID = 189896194266392193L;

	public PersistentClassFormatException(String e) {
		super(e);
	}

	public PersistentClassFormatException(Exception e) {
		super(e);
	}
